...
int main()
{
    set<int> s;  // === 'set<int, less<int>> s;' as by default elements are stored ascending order.
    // we can also use  "set<int, greater<int>> s;" for storing elements in descending order.
